...
//  let first = 8; //объявлена глобальная переменная
// function firstFunction(first) {  // создаем функцию и передаем ей параметр first
//  return first;
//  }
//  console.log(firstFunction(first)); // в консоли вызываем функцию с аргументом
...
console.log(5, calculateArea(width, height));*/
...
// printMessage("hi");// параметр передан
// printMessage();// параметр не передан
...
// console.log(8, thirdFunction()); //Выведет 6
...
// console.log(9, thirdFunction(4)); //Выведет 12
// console.log(10, thirdFunction(5, 6)); //Выведет 30
...
//  function guestGreeting (guestName = "Гость") {
//    return "Привет, " + guestName +"!";
//  }
// console.log(11, guestGreeting("Anna"));
// console.log(12, guestGreeting());
//Задание 10
...
// console.log(13, result()); //Выведет 2
...
// const total = function calculateProduct(e, f) {
//   return e * f;
// };

// console.log(14, total(2, 3)); //Выведет 15
...
//   return a - b;
// };
// console.log(20, "Ваш возраст: " + calculateAge(currentYear, friendYearOfBirth) + " лет");
...
// }
// console.log("Ваш возраст составляет: " + myAge(1982) + " год");
//Задание 18
...
//   return a**b;
// };
// console.log (22, "Результат: " + getNumberDegree(3, 5));